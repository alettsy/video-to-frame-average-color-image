...
fn wire_get_video_seconds_helper_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec, _, _>(
        flutter_rust_bridge::for_generated::TaskInfo {
            debug_name: "get_video_seconds_helper",
            port: Some(port_),
        ...
        move || {
            ...
            move |context| {
                transform_result_sse((move || {
                    Result::<_, ()>::Ok(crate::api::simple::get_video_seconds_helper(api_path))
                })())
            }
        },
    )
...
fn pde_ffi_dispatcher_primary_impl(
    ...
    match func_id {
        3 => wire_get_video_seconds_helper_impl(port, ptr, rust_vec_len, data_len),
...
fn pde_ffi_dispatcher_sync_impl(
    ...
    // Codec=Pde (Serialization + dispatch), see doc to use other codecs
    match func_id {
        2 => wire_generate_image_impl(ptr, rust_vec_len, data_len),
